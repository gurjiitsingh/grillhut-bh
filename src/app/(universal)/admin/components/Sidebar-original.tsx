...
const menuList: Titem[] = [
  ...
  { name: "Employee", link: "/admin/users", icon: <FaUserTie /> },
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar container */}
      <div className="pt-8 h-screen w-[280px] flex flex-col justify-between px-4 py-6  bg-white dark:border-zinc-200 text-zinc-800 dark:text-zinc-100 shadow-md">
        {/* Navigation */}
    ...
    <Link href={item.link}>
      <li
        ...
        ${isSelected
          ...
          : "hover:bg-amber-100 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-600"}`}
      >
